...
- **Resposta esperada:** Valor de R$ 570,00 baseado no `transacoes.csv`
...
- Perfil do investidor completo
- Produtos adequados ao perfil
- Registro organizado de transações

**O que pode melhorar:**
- Acompanhamento automático das metas
- Análise de orçamento e proporções de gastos
- Categorização mais rica no histórico de atendimento
- Comparação mais profunda entre produtos financeiros
